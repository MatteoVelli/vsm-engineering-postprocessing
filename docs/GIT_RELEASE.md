# Git / GitHub Release Procedure - v1.2.0
...
git status
git add .
git commit -m "Release v1.2.0 final deterministic VSM post-processing tool"
git tag -a v1.2.0 -m "VSM Engineering Post-Processing v1.2.0"
git push origin main
git push origin v1.2.0
```

Then create a GitHub Release from tag `v1.2.0` and attach:

- `VSM_Engineering_PostProcessing_v1.2.0_Client.zip`
- `VSM_Engineering_PostProcessing_v1.2.0_Client.sha256`
