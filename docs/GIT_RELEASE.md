# Git / GitHub Release Procedure - v1.2.1
...
git tag -a v1.2.1 -m "VSM Engineering Post-Processing v1.2.1"
git push origin main
git push origin v1.2.1
```

Then create a GitHub Release from tag `v1.2.1` and attach:

- `VSM_Engineering_PostProcessing_v1.2.1_Client.zip`
- `VSM_Engineering_PostProcessing_v1.2.1_Client.sha256`
